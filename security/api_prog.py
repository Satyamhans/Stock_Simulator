...
class Markit:
    def __init__(self):
        ...
        self.lookup_url = "https://financialmodelingprep.com/api/v3/quote/AMZN?apikey=4312c1a211de69687c074fe03bc39b81"
...
def get_stock_price(string):
    ...
    if string is not None:
        ...
        url_concat = "https://financialmodelingprep.com/api/v3/quote/"+string+"?apikey=4312c1a211de69687c074fe03bc39b81"
        r = requests.get(url_concat)
        if r.status_code == 200:
            data = r.json()
            # lis = []
